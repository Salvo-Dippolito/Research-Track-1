    ...
    def grab(self):
        ...
        def object_filter(o):
            ...
            return (o.grabbable and
                    ...
                    not o.grabbed) #returns 1 whenalll these conditions are satisfied
...
local_anchor_b=(0, 0))
    ...
    def see(self, res=(800,600)):
        ...
        def robot_moving(o):
            ...
            return hypot(vx, vy) > MOTION_BLUR_SPEED_THRESHOLD #if the combined linear speed is over 5 robot_moving() returns 1
